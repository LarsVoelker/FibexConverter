...
# Files that use FIBEX features not yet supported by the FLYNC converter (e.g. Multiplex PDUs).
# The FIBEX→FLYNC conversion silently drops unsupported constructs, so the round-trip text
# comparison will always differ for these files.
FLYNC_UNSUPPORTED = {
    "CAN_Multiplex_example",
}
